...
export default function ReviewPostForm({ resId }: Props) {
    ...
    const onCreateReview: MouseEventHandler<HTMLButtonElement> = () => {
        let starRate = 0;

        for(let i = 0; i < 5; i++) {
            if(modalStore.clicked[i] == true) {
                starRate++;
            }
        }
        ...
        <>
            ...
            <div className={styles.reviewInputWrapper}>
                ...
                <div className={styles.uploadButtons}>
                    ...
                    <button className={styles.uploadButton} onClick={onCreateReview}>등록하기</button>
                </div>
            </div>
        </>
    );
